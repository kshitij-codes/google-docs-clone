...
import {
    ...
    , MenubarTrigger, MenubarSeparator, MenubarShortcut, MenubarSub, MenubarSubContent, MenubarSubTrigger
...
export const Navbar = ({data}: NavbarProps) => {
    ...
    const onSaveText = () => {
        ...
        const blob = new Blob([content], {
            type: "text/plain" //TODO: Use document name
            })
        ...
        <nav className="flex items-center justify-between">
            <div className="flex gap-2 items-center">
                ...
                <div className="flex flex-col">
                    <DocumentInput title={document.title} id={data._id} />
                    <div className="flex">
            ...
            <div className="flex gap-3 items-center pl-6 min-w-6">
                <Avatars />
                <Inbox />
